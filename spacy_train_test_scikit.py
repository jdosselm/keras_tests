...
def train(train_texts, train_labels, dev_texts, dev_labels, test_texts, test_labels, sentence_length=100, batch_size=100, nb_epoch=5):
    ...
    for c in [0.8]:
        ...
        train_X = anygram_kernel(train_docs, train_docs, kernel=kernel, vectorizer=vectorizer)
        ...
        s = model.score(anygram_kernel(dev_docs, train_docs, kernel=kernel, vectorizer=vectorizer), dev_labels)
        # s = model.score(anygram_kernel(test_docs, train_docs, kernel=kernel), test_labels)
